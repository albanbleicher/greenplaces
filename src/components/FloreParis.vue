  ...
  <div class="flore">
    ...
    <div class="navigate-trees">
      ...
      <div class="next">
        ...
        <p class="sub-info"><img :src="require('@/assets/leaf.svg')" alt="Leaf">Plus de {{qt_platanus}} arbres compris dans cette famille</p>

    <div class="platanus">

      <div class="infos-tree" v-if="stat_platanus.length">
        <ul class="circ-infos">
